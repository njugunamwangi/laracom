<div x-data="{ category: {}, mobile: false, mobileCategory: {}, subCategory: {}, cart: false }">

    <div x-show="cart" x-cloak @click.away="cart = false" class="relative z-10" aria-labelledby="slide-over-title" role="dialog" aria-modal="true">
        <!--
        ...
        <div class="fixed inset-0 overflow-hidden">
            <div class="absolute inset-0 overflow-hidden">
                <div class="pointer-events-none fixed  bottom-0 right-0 flex max-w-full pl-10">
                    <!--
                ...
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="flex h-16 items-center justify-between">
                        ...
                        <div class="flex items-center lg:ml-8">
                            ...
                            <a @click="cart = !cart" class="group -m-2 flex items-center p-2">
